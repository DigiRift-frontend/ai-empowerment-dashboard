...
export const mockPointTransactions: PointTransaction[] = [
  ...
  { id: 'pt6', date: '2024-12-10', description: 'Chatbot - FAQ Update', points: 4, category: 'wartung', moduleId: 'mod1' },
  { id: 'pt7', date: '2024-12-09', description: 'Telefonat: Anforderungsklärung Reporting', points: 2, category: 'beratung' },
  { id: 'pt8', date: '2024-12-08', description: 'Dokumenten-Analyse - Performance-Tuning', points: 8, category: 'entwicklung', moduleId: 'mod2' },
  { id: 'pt9', date: '2024-12-06', description: 'Projektplanung: Voice-Bot Erweiterung', points: 4, category: 'analyse' },
  { id: 'pt10', date: '2024-12-05', description: 'Monatliche Wartung alle Module', points: 26, category: 'wartung' },
  { id: 'pt11', date: '2024-12-04', description: 'E-Mail Abstimmung: Projektstand', points: 1, category: 'beratung' },
  { id: 'pt12', date: '2024-12-03', description: 'Chatbot - Neue Integrationen', points: 15, category: 'entwicklung', moduleId: 'mod1' },
  { id: 'pt13', date: '2024-12-01', description: 'Strategiemeeting & Roadmap Review', points: 4, category: 'schulung' },
  { id: 'pt14', date: '2024-11-28', description: 'Dokumenten-Analyse - OCR Verbesserung', points: 18, category: 'entwicklung', moduleId: 'mod2' },
  { id: 'pt15', date: '2024-11-26', description: 'Projektmanagement: Sprint Planning', points: 2, category: 'analyse' },
  { id: 'pt16', date: '2024-11-25', description: 'E-Mail Klassifikation - Go-Live Vorbereitung', points: 10, category: 'entwicklung', moduleId: 'mod3' },
  { id: 'pt17', date: '2024-11-22', description: 'Beratungsgespräch: Use-Case Priorisierung', points: 3, category: 'beratung' },
]
...
export const mockRoadmapItems: RoadmapItem[] = [
  ...
  {
    id: 'ri4',
    name: 'Dokumenten-Analyse System',
    description: 'Automatische Analyse und Kategorisierung eingehender Dokumente',
    status: 'abgeschlossen',
    priority: 'hoch',
    progress: 100,
  ...
  {
    id: 'ri6',
    name: 'Prozessautomatisierung RPA',
